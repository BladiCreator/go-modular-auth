...
// InvitationStatus defines the string enum for invitation lifecycle states.
type InvitationStatus string

const (
	// InvitationStatusPending represents an issued invitation awaiting recipient acceptance or rejection.
	InvitationStatusPending InvitationStatus = "pending"

	// InvitationStatusAccepted represents an invitation that was successfully accepted by the invitee.
	InvitationStatusAccepted InvitationStatus = "accepted"

	// InvitationStatusRejected represents an invitation that was explicitly declined by the invitee.
	InvitationStatusRejected InvitationStatus = "rejected"

	// InvitationStatusCanceled represents an invitation revoked by an organization administrator.
